...
def generate_launch_description():
    ...
    robot_description_semantic_config = load_file(
        "dual_rm_65b_moveit_config", "config/dual_rm_65b_description.srdf"
    )
    ...
    kinematics_yaml = load_yaml(
        "dual_rm_65b_moveit_config", "config/kinematics.yaml"
    )

    arm_dof = DeclareLaunchArgument("arm_dof", default_value="6")
